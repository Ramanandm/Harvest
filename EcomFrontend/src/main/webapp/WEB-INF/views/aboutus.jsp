...
<div class="section_bg_gray">
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<div class="ptb-50">
					<h2 class="text-center">ABOUT OUR SERVICE</h2>
				</div>
			</div>
		</div>
		<div class="row">
			<div class="col-sm-6 col-md-4">
				<div class="single_what_we_do">
					...
					<div class="what_we_do_content">Quality is of utmost
						importance to us and that is what we give the most attention to.
						From dal, flour, namkeens and spices to detergents, sanitary
						products and makeup essentials - we aim to cover almost all of
						your household needs..</div>
			...
			<div class="col-sm-6 col-md-4">
				<div class="single_what_we_do">
					...
					<h4 class="what_we_do_title">Best In quality</h4>
					<div class="what_we_do_content">Lorem ipsum dolor amet,
						consectetur adipiscing elit eiusmod.</div>
					<a class="what_we_do_icon" href="#"> <i
						class="fa fa-angle-right" aria-hidden="true"></i>
					</a>
				</div>
			...
			<div class="col-sm-6 col-md-4">
				<div class="single_what_we_do">
					...
					<h4 class="what_we_do_title">safe and sequre</h4>
					<div class="what_we_do_content">Lorem ipsum dolor amet,
						consectetur adipiscing elit eiusmod.</div>
					<a class="what_we_do_icon" href="#"> <i
						class="fa fa-angle-right" aria-hidden="true"></i>
