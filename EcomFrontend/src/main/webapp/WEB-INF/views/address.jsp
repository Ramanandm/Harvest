					...
					<div class="form">
						...
						<div class="form-content form-type-one">
							...
							<form:form action="${url}" modelAttribute="myaddress"
								...
								<form:hidden path="user.cusid" value="${sessionScope.userid}" />
				...
				<c:forEach items="${address_list}" var="v">
					<div class="col-lg-4">
						<div class="thumbnail card">
							<div class="mapouter"><div class="gmap_canvas"><iframe width="343" height="240" id="gmap_canvas" src="https://maps.google.com/maps?q=${v.pincode}&t=&z=13&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe>Werbung: <a href="https://www.pureblack.de">pureblack.de</a></div><style>.mapouter{position:relative;text-align:right;height:240px;width:343px;}.gmap_canvas {overflow:hidden;background:none!important;height:240px;width:343px;}</style></div>
